Este repositorio contiene los archivos de la PEC1 de Análisis de datos ómicos, asignatura del Master de Bioinformática y Bioestadística de la Universidad Obertá de Catalunya (UOC).
